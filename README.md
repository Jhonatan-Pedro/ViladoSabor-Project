...
> Site de restaurante desenvolvido como projeto individual no curso do **Senac**, aprimorado com auxílio de inteligência artificial.

---

## 📌 Sobre o Projeto

O **Vila do Sabor** é um site criado para simular a presença digital de um restaurante sofisticado. O projeto foi desenvolvido individualmente como atividade avaliativa do curso de desenvolvimento de Software no **Senac**, e posteriormente aprimorado com o suporte de IA para elevar a qualidade visual, a estrutura do código e a experiência de navegação.
